            ...
            >
            {
                showFOM ? 
                    <div className="main-text">
                        ...
                        <p>The above is a set of statistical tools to help answer these kinds of questions. This is a Proof Of Concept and requires considerably more data to provide any comprehensive answer to these questions.</p>
                        ...
                        <p>Sentiment analysis categories are identified by crosschecking word lists written by others. These are made by third parties and are not moderated or curated for or by this project.</p>
                    </div> : 
